...
FORMAT_PROFILES: dict[str, FormatProfile] = {
    ...
    "m4a": FormatProfile(
        ...
        extension="m4a",
        codec="aac",
        description="Compatible with Apple devices and modern hardware.",
    ...
    "flac": FormatProfile(
        ...
        extension="flac",
        codec="flac",
        description="Lossless with a solid balance between size and quality.",
        supports_bitrate=False,
    ),
    "ogg": FormatProfile(
        key="ogg",
    ...
    "aiff": FormatProfile(
        ...
        extension="aiff",
        codec="pcm_s16be",
        description="Uncompressed, compatible with professional editing.",
        supports_bitrate=False,
    ),
}
...
def estimate_output_size_text(
    ...
    return f"{estimated_megabytes:.2f} MB"
