...
- Default output path points to the user's Music folder (for example `C:\Users\<user>\Music`).
...
On Windows, if FFmpeg is not in PATH, download the official build and add the bin folder to your environment variables.
